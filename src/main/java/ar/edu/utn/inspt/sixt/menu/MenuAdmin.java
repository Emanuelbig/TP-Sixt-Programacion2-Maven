...
public class MenuAdmin {
    ...
    static void agregarUsuario(Scanner scanner, ar.edu.utn.inspt.sixt.servicios.SixtServicio servicio) {
    ...
    static void agregarOficina(Scanner scanner, ar.edu.utn.inspt.sixt.servicios.SixtServicio servicio) {
    ...
    static void agregarVehiculo(Scanner scanner, ar.edu.utn.inspt.sixt.servicios.SixtServicio servicio) {
    ...
    static void listarVehiculos(ar.edu.utn.inspt.sixt.servicios.SixtServicio servicio) {
        List<ar.edu.utn.inspt.sixt.modelos.Vehiculo> vehiculos = servicio.getVehiculos();
        if (vehiculos.isEmpty()) {
            System.out.println("No hay vehiculos cargados.");
        } else {
            System.out.println("--- VEHICULOS ---");
            for (ar.edu.utn.inspt.sixt.modelos.Vehiculo v : vehiculos) {
                System.out.println(v);
            }
        }
    }

    static void listarReservas(ar.edu.utn.inspt.sixt.servicios.SixtServicio servicio) {
        List<ar.edu.utn.inspt.sixt.modelos.Reserva> reservas = servicio.getReservas();
        if (reservas.isEmpty()) {
            System.out.println("No hay reservas cargadas.");
        } else {
            System.out.println("--- RESERVAS ---");
            for (ar.edu.utn.inspt.sixt.modelos.Reserva r : reservas) {
