...
import ar.edu.utn.inspt.sixt.dao.ReservaDAO;
import ar.edu.utn.inspt.sixt.dao.UsuarioDAO;
import ar.edu.utn.inspt.sixt.dao.VehiculoDAO;
import ar.edu.utn.inspt.sixt.dto.UsuarioDTO;
import java.time.LocalDate;
import java.util.List;
import ar.edu.utn.inspt.sixt.modelos.Usuario;
import ar.edu.utn.inspt.sixt.modelos.Oficina;
import ar.edu.utn.inspt.sixt.modelos.Vehiculo;
import ar.edu.utn.inspt.sixt.modelos.Reserva;
...
public class SixtServicio {
    ...
    private void cargarDatosEnMemoria() {
        ...
        if (this.usuarios.isEmpty()) {
            ...
            ar.edu.utn.inspt.sixt.modelos.Administrador adminRoot = new ar.edu.utn.inspt.sixt.modelos.Administrador(idAdmin, "admin", "1234",
